  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-6 pt-20">
        ...
        <div className="mb-6">
          {/* mobile view */}
          <div className="block md:hidden bg-gradient-to-r from-indigo-600 to-indigo-700 px-4 py-4 rounded-xl mb-4">
          ...
          <div className="hidden md:block overflow-hidden">
            <div className="hidden md:block bg-gradient-to-r from-indigo-600 to-indigo-700 px-4 py-4 rounded-t-xl">
